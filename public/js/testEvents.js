    ...
    $.ajax({
        ...
        .done(function (dataStr) {
            ...
            if (t.length < 5) {
                ...
                alert('Du kan ikke booke mere end fem datoer.');
...
var modalBooking = {
    ...
    openModalPanel: function (data) {
        ...
        $("#modalDate").text('fra: ' + modalDate.toISOString().slice(0, 10) + ' til og med: ' + modalNextDay.toISOString().slice(0, 10));
...
var modalDelete = {
    ...
    openModalPanel: function (data, user, index) {
        ...
        $("#modalDeleteDate").text('fra: ' + modalDate.toISOString().slice(0, 10) + ' til og med: ' + modalNextDay.toISOString().slice(0, 10));
